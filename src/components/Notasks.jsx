...
const Notasks = () => {
  return (
    <>
<<<<<<< HEAD
        <h2 style={{color:'gray'}}>No Tasks till yet,Tap + icon on top</h2>
        <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="gray" className="bi bi-list-task" viewBox="0 0 16 16">
...
>>>>>>> 2bd6e20417afe208a4bf251d47235dffad1f043b
    </>
  );
};
